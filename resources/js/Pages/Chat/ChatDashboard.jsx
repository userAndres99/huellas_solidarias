...
function ChatDashboard({selectedConversation =null, messages = null }) {
  ...
  const loadMoreMessage = useCallback (() => {
    ...
    // encuentra el primer objeto mensaje
...
useEffect(() =>{
  ...
  useEffect(() => {
     ...
     const observer = new IntersectionObserver(
        (entries) =>
          entries.forEach(
            (entry) => entry.isIntersecting && loadMoreMessage()
          ),
      ...
      {!messages && (
          <div className="flex- flex-col gap-8 justify-center items-center text-center h-full opacity-35">
            <div className="text-2xl md:text-4xl p-16 text-slate-800">
                Porfavor seleccione una conversacion para ver los mensajes
            </div>
