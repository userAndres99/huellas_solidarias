...
return [
    ...
    | usados por el validador. Algunas de estas reglas tienen múltiples versiones
    | como las reglas de tamaño. Sentite libre de modificarlas según tus necesidades.
    |
    */
